...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // misiones genericas
        agregarMisionDisponible("Entrega especial", "Entrega un paquete sellado al Gremio de Comerciantes.", "100 XP");
        agregarMisionDisponible("Caza de bandidos", "Elimina a los bandidos del camino del norte.", "200 XP");
    ...
    private void agregarMisionDisponible(String nombre, String descripcion, String recompensa) {
        ...
        btnAceptar.setBackgroundTintList(
    ...
    private void agregarSpell(String nombre, String nivel) {
        ...
        // icono nivel
        TextView badgeNivel = new TextView(this);
        badgeNivel.setText(nivel);
        badgeNivel.setTextColor(getResources().getColor(R.color.dorado));
        badgeNivel.setTextSize(9);
        badgeNivel.setPadding(8, 4, 8, 4);
        badgeNivel.setBackgroundColor(getResources().getColor(R.color.boton_bg));
        LinearLayout.LayoutParams badgeLp = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT);
        badgeLp.setMargins(0, 0, 12, 0);
        badgeNivel.setLayoutParams(badgeLp);
